        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="搜索..."
              className="w-full pl-9 pr-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-sm text-gray-100 placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            />
          </div>
          <button
            onClick={onAddClick}
          ...
          filteredRecords.map((record) => {
            ...
            return (
              <li
                ...
                className={`flex items-center gap-3 p-3 cursor-pointer border-b border-gray-700 transition-colors ${
                  isSelected 
